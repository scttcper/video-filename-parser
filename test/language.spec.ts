...
describe('parseLanguage', () => {
  const tests: Array<[string, Language[]]> = [
    ...
    ['Ouija.Origin.of.Evil.2016.MULTi.TRUEFRENCH.1080p.BluRay.x264-MELBA', [Language.French, Language.English]],
    ...
    ['Der.Soldat.James.German.Bluray.FuckYou.Pso.Why.cant.you.follow.scene.rules.1998', [Language.German]],
    ...
    ['Nocturnal Animals (2016) MULTi VFQ English [1080p] BluRay x264-PopHD', [Language.English, Language.French]],
    ['Wonder.Woman.2017.720p.BluRay.DD5.1.x264-TayTO.CZ-FTU', [Language.Czech]],
    ['Fantastic.Beasts.The.Crimes.Of.Grindelwald.2018.2160p.WEBRip.x265.10bit.HDR.DD5.1-GASMASK', [Language.English]],
  ];
